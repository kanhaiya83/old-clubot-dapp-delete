...
export const customTools: FunctionTool[] = [
	{
		type: "function",
		function: {
	...
	},
	{
		...
		function: {
			name: "getAllBalances",
			description:
				"Get the token balance of the user note: use this function is only if user asking for token balances of all tokens",
			parameters: {
				type: "object",
				properties: {
					address: {
	...
	},
	{
		...
		function: {
			name: "getTopHolders",
			description:
				"Get the top holders of a token on a chain. Note: use this function is only if user asking for top holders of a token",
			parameters: {
				type: "object",
				properties: {
					tokenAddress: {
