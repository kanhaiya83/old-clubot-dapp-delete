...
export const WRAPPED_TOKENS = {
	...
	[bsc.id]: "0x4200000000000000000000000000000000000006",
	[base.id]: "0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c",
	[avalanche.id]: "0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7",
};

export const getWrappedToken = (chainId: any) => {
	return WRAPPED_TOKENS[chainId as keyof typeof WRAPPED_TOKENS];
};
